    ...
    ui(new Ui::MainWindow), database(Mongo)
{
    ...
    //usernameLineEdit->addAction(QIcon("C:/projectOOP/images/avatardefault_92824.ico"), QLineEdit::LeadingPosition);
    //usernameLineEdit1->addAction(QIcon("C:/projectOOP/images/locked.png"), QLineEdit::LeadingPosition);
