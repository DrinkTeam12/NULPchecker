    ...
    database(Mongo)
{
    ...
    QMovie *fire = new QMovie("../images/firerez.gif");
    ui->fire1->setMovie(fire);
    ui->fire2->setMovie(fire);
    ui->fire3->setMovie(fire);
    ui->fire4->setMovie(fire);
    ui->fire5->setMovie(fire);
    fire->start();
...
{
    if (ui->first_lesson->text().isEmpty() == true) {
    ...
    if (ui->third_lesson->text().isEmpty() == true) {
