...
### For Developers:
[Download](https://github.com/DrinkTeam12/NULPchecker/archive/refs/heads/main.zip) download `NULPchecker` from repository. Open `nulp.pro`, change mode from release to debug. Going to the build settings and change assembly directory to the folder where the nulp.pro file is located. `attention mongodb password for connect is incorrect`
