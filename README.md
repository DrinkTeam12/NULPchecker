...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?color=%2336BCF7&lines=We+are+computer+science+students)](https://github.com/DrinkTeam12)
#### Khromiak Nazarii
...
<img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/mongodb/mongodb-original-wordmark.svg" title="Material UI" alt="Material UI" width="40" height="40"/>&nbsp;
...
### For Developers:
[Download](https://github.com/DrinkTeam12/NULPchecker/archive/refs/heads/main.zip) download `NULPchecker` from repository. Open `nulp.pro`, change mode from release to debug. Going to the build settings and change assembly directory to the folder where the nulp.pro file is located. `Pay attention mongodb password for connect is incorrect`.
